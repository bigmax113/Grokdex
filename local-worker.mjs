...
const xliffTranslationContextWindow = Number(process.env.REMOTE_XLIFF_CONTEXT_WINDOW || process.env.LM_CONTEXT_WINDOW || 262144);
...
const xliffTranslationOutputTokens = Number(process.env.REMOTE_XLIFF_TARGET_OUTPUT_TOKENS || process.env.LM_FULL_CONTEXT_TARGET_OUTPUT_TOKENS || 20000);
